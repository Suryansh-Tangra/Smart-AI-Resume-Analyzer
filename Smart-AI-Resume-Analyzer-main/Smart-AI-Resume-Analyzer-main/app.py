...
class ResumeApp:
    ...
    "</ul></div>", unsafe_allow_html=True)
                    ...
                    # Helpful video section disabled temporarily
                    # st.markdown("""
                    #     <div class="feature-card">
                ...
                if analyze_ai:
                    with st.spinner(f"Analyzing your resume with {ai_model}..."):
                        ...
                        try:
                            ...
                            with st.spinner(f"🧠 AI is analyzing your resume with {ai_model}..."):
                                ...
                                # Analyze the resume using the selected model
                                if use_custom_job_desc and custom_job_description:
                                    analysis_result = analyzer.analyze_resume(
                                        resume_text,
                                        job_role=job_role,
                                        role_info={"description": custom_job_description, "required_skills": []},
